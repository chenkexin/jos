...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	00 
  80011b:	c7 44 24 08 da 0f 80 	movl   $0x800fda,0x8(%esp)
  800122:	00 
  800123:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012a:	00 
  80012b:	c7 04 24 f7 0f 80 00 	movl   $0x800ff7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017f:	8b 35 00 20 80 00    	mov    0x802000,%esi
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80024a:	e8 b3 01 00 00       	call   800402 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800305:	e8 e6 09 00 00       	call   800cf0 <__udivdi3>
  ...
  800363:	e8 d8 0a 00 00       	call   800e40 <__umoddi3>
  800368:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80036c:	0f be 80 2e 10 80 00 	movsbl 0x80102e(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800497:	ff 24 85 bc 10 80 00 	jmp    *0x8010bc(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800588:	c7 44 24 08 4f 10 80 	movl   $0x80104f,0x8(%esp)
  80058f:	00 
  ...
  8005ba:	b8 3f 10 80 00       	mov    $0x80103f,%eax
...
00800cf0 <__udivdi3>:
  ...
  800cf3:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  800cf7:	89 7c 24 14          	mov    %edi,0x14(%esp)
  800cfb:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  800cff:	89 6c 24 18          	mov    %ebp,0x18(%esp)
  800d03:	8b 7c 24 20          	mov    0x20(%esp),%edi
  800d07:	8b 6c 24 24          	mov    0x24(%esp),%ebp
  800d0b:	85 c0                	test   %eax,%eax
  800d0d:	89 74 24 10          	mov    %esi,0x10(%esp)
  800d11:	89 7c 24 08          	mov    %edi,0x8(%esp)
  800d15:	89 ea                	mov    %ebp,%edx
  800d17:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  800d1b:	75 33                	jne    800d50 <__udivdi3+0x60>
  800d1d:	39 e9                	cmp    %ebp,%ecx
  800d1f:	77 6f                	ja     800d90 <__udivdi3+0xa0>
  800d21:	85 c9                	test   %ecx,%ecx
  800d23:	89 ce                	mov    %ecx,%esi
  800d25:	75 0b                	jne    800d32 <__udivdi3+0x42>
  ...
  800d36:	f7 f6                	div    %esi
  800d38:	89 c5                	mov    %eax,%ebp
  800d3a:	89 f8                	mov    %edi,%eax
  800d3c:	f7 f6                	div    %esi
  800d3e:	89 ea                	mov    %ebp,%edx
  800d40:	8b 74 24 10          	mov    0x10(%esp),%esi
  800d44:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800d48:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  800d4c:	83 c4 1c             	add    $0x1c,%esp
  800d4f:	c3                   	ret    
  800d50:	39 e8                	cmp    %ebp,%eax
  800d52:	77 24                	ja     800d78 <__udivdi3+0x88>
  800d54:	0f bd c8             	bsr    %eax,%ecx
  800d57:	83 f1 1f             	xor    $0x1f,%ecx
  800d5a:	89 0c 24             	mov    %ecx,(%esp)
  800d5d:	75 49                	jne    800da8 <__udivdi3+0xb8>
  800d5f:	8b 74 24 08          	mov    0x8(%esp),%esi
  800d63:	39 74 24 04          	cmp    %esi,0x4(%esp)
  800d67:	0f 86 ab 00 00 00    	jbe    800e18 <__udivdi3+0x128>
  800d6d:	39 e8                	cmp    %ebp,%eax
  800d6f:	0f 82 a3 00 00 00    	jb     800e18 <__udivdi3+0x128>
  800d75:	8d 76 00             	lea    0x0(%esi),%esi
  800d78:	31 d2                	xor    %edx,%edx
  800d7a:	31 c0                	xor    %eax,%eax
  800d7c:	8b 74 24 10          	mov    0x10(%esp),%esi
  800d80:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800d84:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  ...
  800d96:	8b 74 24 10          	mov    0x10(%esp),%esi
  800d9a:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800d9e:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  800da2:	83 c4 1c             	add    $0x1c,%esp
  800da5:	c3                   	ret    
  800da6:	66 90                	xchg   %ax,%ax
  800da8:	0f b6 0c 24          	movzbl (%esp),%ecx
  800dac:	89 c6                	mov    %eax,%esi
  800dae:	b8 20 00 00 00       	mov    $0x20,%eax
  800db3:	8b 6c 24 04          	mov    0x4(%esp),%ebp
  800db7:	2b 04 24             	sub    (%esp),%eax
  800dba:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800dbe:	d3 e6                	shl    %cl,%esi
  800dc0:	89 c1                	mov    %eax,%ecx
  800dc2:	d3 ed                	shr    %cl,%ebp
  800dc4:	0f b6 0c 24          	movzbl (%esp),%ecx
  800dc8:	09 f5                	or     %esi,%ebp
  ...
  800dda:	0f b6 0c 24          	movzbl (%esp),%ecx
  800dde:	d3 e2                	shl    %cl,%edx
  800de0:	89 c1                	mov    %eax,%ecx
  800de2:	d3 ef                	shr    %cl,%edi
  800de4:	09 d7                	or     %edx,%edi
  800de6:	89 f2                	mov    %esi,%edx
  800de8:	89 f8                	mov    %edi,%eax
  800dea:	f7 f5                	div    %ebp
  800dec:	89 d6                	mov    %edx,%esi
  800dee:	89 c7                	mov    %eax,%edi
  800df0:	f7 64 24 04          	mull   0x4(%esp)
  800df4:	39 d6                	cmp    %edx,%esi
  800df6:	72 30                	jb     800e28 <__udivdi3+0x138>
  800df8:	8b 6c 24 08          	mov    0x8(%esp),%ebp
  800dfc:	0f b6 0c 24          	movzbl (%esp),%ecx
  800e00:	d3 e5                	shl    %cl,%ebp
  800e02:	39 c5                	cmp    %eax,%ebp
  800e04:	73 04                	jae    800e0a <__udivdi3+0x11a>
  800e06:	39 d6                	cmp    %edx,%esi
  800e08:	74 1e                	je     800e28 <__udivdi3+0x138>
  800e0a:	89 f8                	mov    %edi,%eax
  800e0c:	31 d2                	xor    %edx,%edx
  800e0e:	e9 69 ff ff ff       	jmp    800d7c <__udivdi3+0x8c>
  800e13:	90                   	nop
  800e14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800e18:	31 d2                	xor    %edx,%edx
  800e1a:	b8 01 00 00 00       	mov    $0x1,%eax
  800e1f:	e9 58 ff ff ff       	jmp    800d7c <__udivdi3+0x8c>
  800e24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800e28:	8d 47 ff             	lea    -0x1(%edi),%eax
  800e2b:	31 d2                	xor    %edx,%edx
  800e2d:	8b 74 24 10          	mov    0x10(%esp),%esi
  800e31:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800e35:	8b 6c 24 18          	mov    0x18(%esp),%ebp
...
00800e40 <__umoddi3>:
  ...
  800e43:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  800e47:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  800e4b:	89 74 24 20          	mov    %esi,0x20(%esp)
  800e4f:	8b 74 24 38          	mov    0x38(%esp),%esi
  800e53:	89 7c 24 24          	mov    %edi,0x24(%esp)
  800e57:	8b 7c 24 34          	mov    0x34(%esp),%edi
  800e5b:	85 c0                	test   %eax,%eax
  800e5d:	89 c2                	mov    %eax,%edx
  800e5f:	89 6c 24 28          	mov    %ebp,0x28(%esp)
  800e63:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
  800e67:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800e6b:	89 74 24 10          	mov    %esi,0x10(%esp)
  800e6f:	89 4c 24 14          	mov    %ecx,0x14(%esp)
  800e73:	89 7c 24 18          	mov    %edi,0x18(%esp)
  800e77:	75 1f                	jne    800e98 <__umoddi3+0x58>
  800e79:	39 fe                	cmp    %edi,%esi
  800e7b:	76 63                	jbe    800ee0 <__umoddi3+0xa0>
  800e7d:	89 c8                	mov    %ecx,%eax
  800e7f:	89 fa                	mov    %edi,%edx
  800e81:	f7 f6                	div    %esi
  800e83:	89 d0                	mov    %edx,%eax
  800e85:	31 d2                	xor    %edx,%edx
  800e87:	8b 74 24 20          	mov    0x20(%esp),%esi
  800e8b:	8b 7c 24 24          	mov    0x24(%esp),%edi
  800e8f:	8b 6c 24 28          	mov    0x28(%esp),%ebp
  800e93:	83 c4 2c             	add    $0x2c,%esp
  800e96:	c3                   	ret    
  800e97:	90                   	nop
  800e98:	39 f8                	cmp    %edi,%eax
  800e9a:	77 64                	ja     800f00 <__umoddi3+0xc0>
  800e9c:	0f bd e8             	bsr    %eax,%ebp
  800e9f:	83 f5 1f             	xor    $0x1f,%ebp
  800ea2:	75 74                	jne    800f18 <__umoddi3+0xd8>
  800ea4:	8b 7c 24 14          	mov    0x14(%esp),%edi
  800ea8:	39 7c 24 10          	cmp    %edi,0x10(%esp)
  800eac:	0f 87 0e 01 00 00    	ja     800fc0 <__umoddi3+0x180>
  800eb2:	8b 7c 24 0c          	mov    0xc(%esp),%edi
  800eb6:	29 f1                	sub    %esi,%ecx
  800eb8:	19 c7                	sbb    %eax,%edi
  800eba:	89 4c 24 14          	mov    %ecx,0x14(%esp)
  800ebe:	89 7c 24 18          	mov    %edi,0x18(%esp)
  800ec2:	8b 44 24 14          	mov    0x14(%esp),%eax
  800ec6:	8b 54 24 18          	mov    0x18(%esp),%edx
  800eca:	8b 74 24 20          	mov    0x20(%esp),%esi
  800ece:	8b 7c 24 24          	mov    0x24(%esp),%edi
  800ed2:	8b 6c 24 28          	mov    0x28(%esp),%ebp
  800ed6:	83 c4 2c             	add    $0x2c,%esp
  800ed9:	c3                   	ret    
  800eda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  800ee0:	85 f6                	test   %esi,%esi
  800ee2:	89 f5                	mov    %esi,%ebp
  800ee4:	75 0b                	jne    800ef1 <__umoddi3+0xb1>
  800ee6:	b8 01 00 00 00       	mov    $0x1,%eax
  800eeb:	31 d2                	xor    %edx,%edx
  800eed:	f7 f6                	div    %esi
  ...
  800efb:	f7 f5                	div    %ebp
  800efd:	eb 84                	jmp    800e83 <__umoddi3+0x43>
  800eff:	90                   	nop
  800f00:	89 c8                	mov    %ecx,%eax
  800f02:	89 fa                	mov    %edi,%edx
  800f04:	8b 74 24 20          	mov    0x20(%esp),%esi
  800f08:	8b 7c 24 24          	mov    0x24(%esp),%edi
  800f0c:	8b 6c 24 28          	mov    0x28(%esp),%ebp
  800f10:	83 c4 2c             	add    $0x2c,%esp
  800f13:	c3                   	ret    
  800f14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800f18:	8b 44 24 10          	mov    0x10(%esp),%eax
  800f1c:	be 20 00 00 00       	mov    $0x20,%esi
  800f21:	89 e9                	mov    %ebp,%ecx
  800f23:	29 ee                	sub    %ebp,%esi
  800f25:	d3 e2                	shl    %cl,%edx
  800f27:	89 f1                	mov    %esi,%ecx
  800f29:	d3 e8                	shr    %cl,%eax
  800f2b:	89 e9                	mov    %ebp,%ecx
  800f2d:	09 d0                	or     %edx,%eax
  800f2f:	89 fa                	mov    %edi,%edx
  800f31:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f35:	8b 44 24 10          	mov    0x10(%esp),%eax
  800f39:	d3 e0                	shl    %cl,%eax
  800f3b:	89 f1                	mov    %esi,%ecx
  800f3d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800f41:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800f45:	d3 ea                	shr    %cl,%edx
  800f47:	89 e9                	mov    %ebp,%ecx
  800f49:	d3 e7                	shl    %cl,%edi
  800f4b:	89 f1                	mov    %esi,%ecx
  800f4d:	d3 e8                	shr    %cl,%eax
  800f4f:	89 e9                	mov    %ebp,%ecx
  800f51:	09 f8                	or     %edi,%eax
  800f53:	8b 7c 24 1c          	mov    0x1c(%esp),%edi
  800f57:	f7 74 24 0c          	divl   0xc(%esp)
  800f5b:	d3 e7                	shl    %cl,%edi
  800f5d:	89 7c 24 18          	mov    %edi,0x18(%esp)
  800f61:	89 d7                	mov    %edx,%edi
  800f63:	f7 64 24 10          	mull   0x10(%esp)
  800f67:	39 d7                	cmp    %edx,%edi
  800f69:	89 c1                	mov    %eax,%ecx
  800f6b:	89 54 24 14          	mov    %edx,0x14(%esp)
  800f6f:	72 3b                	jb     800fac <__umoddi3+0x16c>
  800f71:	39 44 24 18          	cmp    %eax,0x18(%esp)
  800f75:	72 31                	jb     800fa8 <__umoddi3+0x168>
  800f77:	8b 44 24 18          	mov    0x18(%esp),%eax
  800f7b:	29 c8                	sub    %ecx,%eax
  800f7d:	19 d7                	sbb    %edx,%edi
  ...
  800f91:	8b 74 24 20          	mov    0x20(%esp),%esi
  800f95:	8b 7c 24 24          	mov    0x24(%esp),%edi
  800f99:	8b 6c 24 28          	mov    0x28(%esp),%ebp
  800f9d:	83 c4 2c             	add    $0x2c,%esp
  800fa0:	c3                   	ret    
  800fa1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  800fa8:	39 d7                	cmp    %edx,%edi
  800faa:	75 cb                	jne    800f77 <__umoddi3+0x137>
  800fac:	8b 54 24 14          	mov    0x14(%esp),%edx
  800fb0:	89 c1                	mov    %eax,%ecx
  800fb2:	2b 4c 24 10          	sub    0x10(%esp),%ecx
  800fb6:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  800fba:	eb bb                	jmp    800f77 <__umoddi3+0x137>
  800fbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800fc0:	3b 44 24 18          	cmp    0x18(%esp),%eax
  800fc4:	0f 82 e8 fe ff ff    	jb     800eb2 <__umoddi3+0x72>
  800fca:	e9 f3 fe ff ff       	jmp    800ec2 <__umoddi3+0x82>
