...
sys_env_destroy(envid_t envid)
{
  ...
  800132:	00 
  800133:	c7 44 24 08 08 10 80 	movl   $0x801008,0x8(%esp)
  80013a:	00 
  80013b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800142:	00 
  800143:	c7 04 24 25 10 80 00 	movl   $0x801025,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800197:	8b 35 04 20 80 00    	mov    0x802004,%esi
  ...
  8001b8:	c7 04 24 34 10 80 00 	movl   $0x801034,(%esp)
  ...
  8001ce:	e8 53 00 00 00       	call   800226 <vcprintf>
	cprintf("\n");
  8001d3:	c7 04 24 fc 0f 80 00 	movl   $0x800ffc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80038c:	0f be 80 58 10 80 00 	movsbl 0x801058(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004b7:	ff 24 85 e8 10 80 00 	jmp    *0x8010e8(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8005a8:	c7 44 24 08 79 10 80 	movl   $0x801079,0x8(%esp)
  8005af:	00 
  ...
  8005da:	b8 69 10 80 00       	mov    $0x801069,%eax
