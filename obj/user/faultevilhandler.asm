...
sys_env_destroy(envid_t envid)
{
  ...
  80016e:	00 
  80016f:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  800176:	00 
  800177:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80017e:	00 
  80017f:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80022d:	00 
  80022e:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  800235:	00 
  800236:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80023d:	00 
  80023e:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80028b:	00 
  80028c:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  800293:	00 
  800294:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80029b:	00 
  80029c:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002e9:	00 
  8002ea:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  8002f1:	00 
  8002f2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002f9:	00 
  8002fa:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800347:	00 
  800348:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  80034f:	00 
  800350:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800357:	00 
  800358:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003a5:	00 
  8003a6:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  8003ad:	00 
  8003ae:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003b5:	00 
  8003b6:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800436:	00 
  800437:	c7 44 24 08 ca 12 80 	movl   $0x8012ca,0x8(%esp)
  80043e:	00 
  80043f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800446:	00 
  800447:	c7 04 24 e7 12 80 00 	movl   $0x8012e7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80046b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  ...
  800484:	89 74 24 08          	mov    %esi,0x8(%esp)
  800488:	89 44 24 04          	mov    %eax,0x4(%esp)
  80048c:	c7 04 24 f8 12 80 00 	movl   $0x8012f8,(%esp)
  ...
  8004a2:	e8 53 00 00 00       	call   8004fa <vcprintf>
	cprintf("\n");
  8004a7:	c7 04 24 1c 13 80 00 	movl   $0x80131c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80065c:	0f be 80 1e 13 80 00 	movsbl 0x80131e(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800858:	c7 44 24 08 36 13 80 	movl   $0x801336,0x8(%esp)
  80085f:	00 
  ...
  800878:	c7 44 24 08 3f 13 80 	movl   $0x80133f,0x8(%esp)
  80087f:	00 
  ...
  8008aa:	b8 2f 13 80 00       	mov    $0x80132f,%eax
