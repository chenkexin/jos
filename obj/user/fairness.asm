...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 20             	sub    $0x20,%esp
	...
	id = sys_getenvid();
  80003c:	e8 cb 0c 00 00       	call   800d0c <sys_getenvid>
  ...
  800065:	e8 6a 0f 00 00       	call   800fd4 <ipc_recv>
  ...
  8000bc:	e8 35 0f 00 00       	call   800ff6 <ipc_send>
...
libmain(int argc, char **argv)
{
  ...
  8000d6:	e8 31 0c 00 00       	call   800d0c <sys_getenvid>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800265:	e8 56 0e 00 00       	call   8010c0 <__udivdi3>
  ...
  8002c3:	e8 48 0f 00 00       	call   801210 <__umoddi3>
  8002c8:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002cc:	0f be 80 d2 13 80 00 	movsbl 0x8013d2(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003f7:	ff 24 85 a0 14 80 00 	jmp    *0x8014a0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004e8:	c7 44 24 08 f3 13 80 	movl   $0x8013f3,0x8(%esp)
  8004ef:	00 
  ...
  80051a:	b8 e3 13 80 00       	mov    $0x8013e3,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ce2:	00 
  800ce3:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800cea:	00 
  800ceb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cf2:	00 
  800cf3:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
  800cfa:	e8 61 03 00 00       	call   801060 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800da1:	00 
  800da2:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800da9:	00 
  800daa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800db1:	00 
  800db2:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
  800db9:	e8 a2 02 00 00       	call   801060 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800dff:	00 
  800e00:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800e07:	00 
  800e08:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e0f:	00 
  800e10:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
  800e17:	e8 44 02 00 00       	call   801060 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e5d:	00 
  800e5e:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800e65:	00 
  800e66:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6d:	00 
  800e6e:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
  800e75:	e8 e6 01 00 00       	call   801060 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ebb:	00 
  800ebc:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800ec3:	00 
  800ec4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ecb:	00 
  800ecc:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
  800ed3:	e8 88 01 00 00       	call   801060 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f19:	00 
  800f1a:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800f21:	00 
  800f22:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f29:	00 
  800f2a:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
  800f31:	e8 2a 01 00 00       	call   801060 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800faa:	00 
  800fab:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800fb2:	00 
  800fb3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fba:	00 
  800fbb:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
  800fc2:	e8 99 00 00 00       	call   801060 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800fda:	c7 44 24 08 4f 16 80 	movl   $0x80164f,0x8(%esp)
  800fe1:	00 
  800fe2:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800fe9:	00 
  800fea:	c7 04 24 68 16 80 00 	movl   $0x801668,(%esp)
  800ff1:	e8 6a 00 00 00       	call   801060 <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800ffc:	c7 44 24 08 72 16 80 	movl   $0x801672,0x8(%esp)
  801003:	00 
  801004:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  80100b:	00 
  80100c:	c7 04 24 68 16 80 00 	movl   $0x801668,(%esp)
  801013:	e8 48 00 00 00       	call   801060 <_panic>

00801018 <ipc_find_env>:
...
ipc_find_env(enum EnvType type)
{
  ...
  80101e:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801023:	39 c8                	cmp    %ecx,%eax
  801025:	74 17                	je     80103e <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801027:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  80102c:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80102f:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801035:	8b 52 50             	mov    0x50(%edx),%edx
  801038:	39 ca                	cmp    %ecx,%edx
  80103a:	75 14                	jne    801050 <ipc_find_env+0x38>
  80103c:	eb 05                	jmp    801043 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801046:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  80104b:	8b 40 40             	mov    0x40(%eax),%eax
  80104e:	eb 0e                	jmp    80105e <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801053:	3d 00 04 00 00       	cmp    $0x400,%eax
  801058:	75 d2                	jne    80102c <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  80105a:	66 b8 00 00          	mov    $0x0,%ax
}
  80105e:	5d                   	pop    %ebp
  80105f:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801065:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  801068:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80106b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801071:	e8 96 fc ff ff       	call   800d0c <sys_getenvid>
  801076:	8b 55 0c             	mov    0xc(%ebp),%edx
  801079:	89 54 24 10          	mov    %edx,0x10(%esp)
  80107d:	8b 55 08             	mov    0x8(%ebp),%edx
  801080:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801084:	89 74 24 08          	mov    %esi,0x8(%esp)
  801088:	89 44 24 04          	mov    %eax,0x4(%esp)
  80108c:	c7 04 24 8c 16 80 00 	movl   $0x80168c,(%esp)
  801093:	e8 33 f1 ff ff       	call   8001cb <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801098:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80109c:	8b 45 10             	mov    0x10(%ebp),%eax
  80109f:	89 04 24             	mov    %eax,(%esp)
  8010a2:	e8 c3 f0 ff ff       	call   80016a <vcprintf>
	cprintf("\n");
  8010a7:	c7 04 24 af 13 80 00 	movl   $0x8013af,(%esp)
  8010ae:	e8 18 f1 ff ff       	call   8001cb <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8010b3:	cc                   	int3   
  8010b4:	eb fd                	jmp    8010b3 <_panic+0x53>
	...
