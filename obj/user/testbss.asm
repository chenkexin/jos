...
libmain(int argc, char **argv)
{
  ...
  800132:	e8 85 0c 00 00       	call   800dbc <sys_getenvid>
...
exit(void)
{
  ...
  80017d:	e8 dd 0b 00 00       	call   800d5f <sys_env_destroy>
}
  800182:	c9                   	leave  
  800183:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800195:	e8 22 0c 00 00       	call   800dbc <sys_getenvid>
  ...
  8001b0:	c7 04 24 48 14 80 00 	movl   $0x801448,(%esp)
  ...
  8001c6:	e8 53 00 00 00       	call   80021e <vcprintf>
	cprintf("\n");
  8001cb:	c7 04 24 16 14 80 00 	movl   $0x801416,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800315:	e8 76 0d 00 00       	call   801090 <__udivdi3>
  ...
  800373:	e8 68 0e 00 00       	call   8011e0 <__umoddi3>
  800378:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80037c:	0f be 80 6c 14 80 00 	movsbl 0x80146c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004a7:	ff 24 85 40 15 80 00 	jmp    *0x801540(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800598:	c7 44 24 08 8d 14 80 	movl   $0x80148d,0x8(%esp)
  80059f:	00 
  ...
  8005ca:	b8 7d 14 80 00       	mov    $0x80147d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800daa:	e8 d5 f3 ff ff       	call   800184 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e69:	e8 16 f3 ff ff       	call   800184 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ec7:	e8 b8 f2 ff ff       	call   800184 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800f25:	e8 5a f2 ff ff       	call   800184 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f83:	e8 fc f1 ff ff       	call   800184 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800fe1:	e8 9e f1 ff ff       	call   800184 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  801072:	e8 0d f1 ff ff       	call   800184 <_panic>
