...
umain(int argc, char **argv)
{
  ...
  800047:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  80004e:	e8 74 01 00 00       	call   8001c7 <cprintf>
	if ((env = fork()) == 0) {
  800053:	e8 7c 0f 00 00       	call   800fd4 <fork>
  800058:	89 c3                	mov    %eax,%ebx
  80005a:	85 c0                	test   %eax,%eax
  80005c:	75 0e                	jne    80006c <umain+0x2c>
		cprintf("I am the child.  Spinning...\n");
  80005e:	c7 04 24 d8 13 80 00 	movl   $0x8013d8,(%esp)
  ...
  80006c:	c7 04 24 88 13 80 00 	movl   $0x801388,(%esp)
  ...
  8000a5:	c7 04 24 b0 13 80 00 	movl   $0x8013b0,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  8000d2:	e8 35 0c 00 00       	call   800d0c <sys_getenvid>
...
exit(void)
{
  ...
  80011d:	e8 8d 0b 00 00       	call   800caf <sys_env_destroy>
}
  800122:	c9                   	leave  
  800123:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  800151:	e8 fa 0a 00 00       	call   800c50 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001a2:	e8 bb 01 00 00       	call   800362 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001ba:	e8 91 0a 00 00       	call   800c50 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800265:	e8 06 0e 00 00       	call   801070 <__udivdi3>
  ...
  8002c3:	e8 f8 0e 00 00       	call   8011c0 <__umoddi3>
  8002c8:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002cc:	0f be 80 00 14 80 00 	movsbl 0x801400(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003f7:	ff 24 85 c0 14 80 00 	jmp    *0x8014c0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  8004e8:	c7 44 24 08 21 14 80 	movl   $0x801421,0x8(%esp)
  8004ef:	00 
  ...
  80051a:	b8 11 14 80 00       	mov    $0x801411,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ce2:	00 
  800ce3:	c7 44 24 08 44 16 80 	movl   $0x801644,0x8(%esp)
  800cea:	00 
  800ceb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cf2:	00 
  800cf3:	c7 04 24 61 16 80 00 	movl   $0x801661,(%esp)
  800cfa:	e8 19 03 00 00       	call   801018 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800da1:	00 
  800da2:	c7 44 24 08 44 16 80 	movl   $0x801644,0x8(%esp)
  800da9:	00 
  800daa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800db1:	00 
  800db2:	c7 04 24 61 16 80 00 	movl   $0x801661,(%esp)
  800db9:	e8 5a 02 00 00       	call   801018 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800dff:	00 
  800e00:	c7 44 24 08 44 16 80 	movl   $0x801644,0x8(%esp)
  800e07:	00 
  800e08:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e0f:	00 
  800e10:	c7 04 24 61 16 80 00 	movl   $0x801661,(%esp)
  800e17:	e8 fc 01 00 00       	call   801018 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e5d:	00 
  800e5e:	c7 44 24 08 44 16 80 	movl   $0x801644,0x8(%esp)
  800e65:	00 
  800e66:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6d:	00 
  800e6e:	c7 04 24 61 16 80 00 	movl   $0x801661,(%esp)
  800e75:	e8 9e 01 00 00       	call   801018 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ebb:	00 
  800ebc:	c7 44 24 08 44 16 80 	movl   $0x801644,0x8(%esp)
  800ec3:	00 
  800ec4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ecb:	00 
  800ecc:	c7 04 24 61 16 80 00 	movl   $0x801661,(%esp)
  800ed3:	e8 40 01 00 00       	call   801018 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f19:	00 
  800f1a:	c7 44 24 08 44 16 80 	movl   $0x801644,0x8(%esp)
  800f21:	00 
  800f22:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f29:	00 
  800f2a:	c7 04 24 61 16 80 00 	movl   $0x801661,(%esp)
  800f31:	e8 e2 00 00 00       	call   801018 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800faa:	00 
  800fab:	c7 44 24 08 44 16 80 	movl   $0x801644,0x8(%esp)
  800fb2:	00 
  800fb3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fba:	00 
  800fbb:	c7 04 24 61 16 80 00 	movl   $0x801661,(%esp)
  800fc2:	e8 51 00 00 00       	call   801018 <_panic>
...
fork(void)
{
  ...
  800fda:	c7 44 24 08 7b 16 80 	movl   $0x80167b,0x8(%esp)
  800fe1:	00 
  800fe2:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  800fe9:	00 
  800fea:	c7 04 24 6f 16 80 00 	movl   $0x80166f,(%esp)
  800ff1:	e8 22 00 00 00       	call   801018 <_panic>
...
sfork(void)
{
  ...
  800ffc:	c7 44 24 08 7a 16 80 	movl   $0x80167a,0x8(%esp)
  801003:	00 
  801004:	c7 44 24 04 59 00 00 	movl   $0x59,0x4(%esp)
  80100b:	00 
  80100c:	c7 04 24 6f 16 80 00 	movl   $0x80166f,(%esp)
  801013:	e8 00 00 00 00       	call   801018 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80101d:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  801020:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  801023:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801029:	e8 de fc ff ff       	call   800d0c <sys_getenvid>
  80102e:	8b 55 0c             	mov    0xc(%ebp),%edx
  801031:	89 54 24 10          	mov    %edx,0x10(%esp)
  ...
  801044:	c7 04 24 90 16 80 00 	movl   $0x801690,(%esp)
  80104b:	e8 77 f1 ff ff       	call   8001c7 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801050:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801054:	8b 45 10             	mov    0x10(%ebp),%eax
  801057:	89 04 24             	mov    %eax,(%esp)
  80105a:	e8 07 f1 ff ff       	call   800166 <vcprintf>
	cprintf("\n");
  80105f:	c7 04 24 f4 13 80 00 	movl   $0x8013f4,(%esp)
  801066:	e8 5c f1 ff ff       	call   8001c7 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80106b:	cc                   	int3   
  80106c:	eb fd                	jmp    80106b <_panic+0x53>
	...
