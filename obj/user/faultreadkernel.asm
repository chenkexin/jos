	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025c:	0f be 80 d1 12 80 00 	movsbl 0x8012d1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800387:	ff 24 85 a0 13 80 00 	jmp    *0x8013a0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800458:	c7 44 24 08 e9 12 80 	movl   $0x8012e9,0x8(%esp)
  80045f:	00 
  ...
  800478:	c7 44 24 08 f2 12 80 	movl   $0x8012f2,0x8(%esp)
  80047f:	00 
  ...
  8004aa:	b8 e2 12 80 00       	mov    $0x8012e2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c72:	00 
  800c73:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800c7a:	00 
  800c7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c82:	00 
  800c83:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d31:	00 
  800d32:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800d39:	00 
  800d3a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d41:	00 
  800d42:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d8f:	00 
  800d90:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800d97:	00 
  800d98:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d9f:	00 
  800da0:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ded:	00 
  800dee:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800df5:	00 
  800df6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfd:	00 
  800dfe:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e4b:	00 
  800e4c:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800e53:	00 
  800e54:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e5b:	00 
  800e5c:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ea9:	00 
  800eaa:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800eb1:	00 
  800eb2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eb9:	00 
  800eba:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800f3a:	00 
  800f3b:	c7 44 24 08 24 15 80 	movl   $0x801524,0x8(%esp)
  800f42:	00 
  800f43:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f4a:	00 
  800f4b:	c7 04 24 41 15 80 00 	movl   $0x801541,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f90:	c7 04 24 50 15 80 00 	movl   $0x801550,(%esp)
  ...
  800fa6:	e8 4f f1 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800fab:	c7 04 24 74 15 80 00 	movl   $0x801574,(%esp)
