...
umain(int argc, char **argv)
{
  ...
  800043:	c7 04 24 f0 0f 80 00 	movl   $0x800ff0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d5:	e8 36 0b 00 00       	call   800d10 <__udivdi3>
  ...
  800233:	e8 28 0c 00 00       	call   800e60 <__umoddi3>
  800238:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80023c:	0f be 80 21 10 80 00 	movsbl 0x801021(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800367:	ff 24 85 b0 10 80 00 	jmp    *0x8010b0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800458:	c7 44 24 08 42 10 80 	movl   $0x801042,0x8(%esp)
  80045f:	00 
  ...
  80048a:	b8 32 10 80 00       	mov    $0x801032,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c52:	00 
  800c53:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800c5a:	00 
  800c5b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c62:	00 
  800c63:	c7 04 24 41 12 80 00 	movl   $0x801241,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cb7:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800cbd:	e8 ba ff ff ff       	call   800c7c <sys_getenvid>
  800cc2:	8b 55 0c             	mov    0xc(%ebp),%edx
  800cc5:	89 54 24 10          	mov    %edx,0x10(%esp)
  800cc9:	8b 55 08             	mov    0x8(%ebp),%edx
  800ccc:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800cd0:	89 74 24 08          	mov    %esi,0x8(%esp)
  800cd4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800cd8:	c7 04 24 50 12 80 00 	movl   $0x801250,(%esp)
  800cdf:	e8 5f f4 ff ff       	call   800143 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ce4:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800ce8:	8b 45 10             	mov    0x10(%ebp),%eax
  800ceb:	89 04 24             	mov    %eax,(%esp)
  800cee:	e8 ef f3 ff ff       	call   8000e2 <vcprintf>
	cprintf("\n");
  800cf3:	c7 04 24 74 12 80 00 	movl   $0x801274,(%esp)
  800cfa:	e8 44 f4 ff ff       	call   800143 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800cff:	cc                   	int3   
  800d00:	eb fd                	jmp    800cff <_panic+0x53>
	...
