	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e5:	e8 36 0b 00 00       	call   800d20 <__udivdi3>
  ...
  800243:	e8 28 0c 00 00       	call   800e70 <__umoddi3>
  800248:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80024c:	0f be 80 2f 10 80 00 	movsbl 0x80102f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800377:	ff 24 85 bc 10 80 00 	jmp    *0x8010bc(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800468:	c7 44 24 08 50 10 80 	movl   $0x801050,0x8(%esp)
  80046f:	00 
  ...
  80049a:	b8 40 10 80 00       	mov    $0x801040,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c62:	00 
  800c63:	c7 44 24 08 30 12 80 	movl   $0x801230,0x8(%esp)
  800c6a:	00 
  800c6b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c72:	00 
  800c73:	c7 04 24 4d 12 80 00 	movl   $0x80124d,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cc7:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800ccd:	e8 ba ff ff ff       	call   800c8c <sys_getenvid>
  800cd2:	8b 55 0c             	mov    0xc(%ebp),%edx
  800cd5:	89 54 24 10          	mov    %edx,0x10(%esp)
  800cd9:	8b 55 08             	mov    0x8(%ebp),%edx
  800cdc:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800ce0:	89 74 24 08          	mov    %esi,0x8(%esp)
  800ce4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ce8:	c7 04 24 5c 12 80 00 	movl   $0x80125c,(%esp)
  800cef:	e8 5b f4 ff ff       	call   80014f <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800cf4:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800cf8:	8b 45 10             	mov    0x10(%ebp),%eax
  800cfb:	89 04 24             	mov    %eax,(%esp)
  800cfe:	e8 eb f3 ff ff       	call   8000ee <vcprintf>
	cprintf("\n");
  800d03:	c7 04 24 0c 10 80 00 	movl   $0x80100c,(%esp)
  800d0a:	e8 40 f4 ff ff       	call   80014f <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800d0f:	cc                   	int3   
  800d10:	eb fd                	jmp    800d0f <_panic+0x53>
	...
