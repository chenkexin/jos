...
libmain(int argc, char **argv)
{
  ...
  80007a:	e8 2d 0c 00 00       	call   800cac <sys_getenvid>
...
exit(void)
{
  ...
  8000c5:	e8 85 0b 00 00       	call   800c4f <sys_env_destroy>
}
  8000ca:	c9                   	leave  
  8000cb:	c3                   	ret    
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80026c:	0f be 80 d8 12 80 00 	movsbl 0x8012d8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800468:	c7 44 24 08 f0 12 80 	movl   $0x8012f0,0x8(%esp)
  80046f:	00 
  ...
  800488:	c7 44 24 08 f9 12 80 	movl   $0x8012f9,0x8(%esp)
  80048f:	00 
  ...
  8004ba:	b8 e9 12 80 00       	mov    $0x8012e9,%eax
