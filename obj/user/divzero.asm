...
umain(int argc, char **argv)
{
  ...
  800059:	c7 04 24 10 10 80 00 	movl   $0x801010,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f5:	e8 36 0b 00 00       	call   800d30 <__udivdi3>
  ...
  800253:	e8 28 0c 00 00       	call   800e80 <__umoddi3>
  800258:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80025c:	0f be 80 28 10 80 00 	movsbl 0x801028(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800387:	ff 24 85 b8 10 80 00 	jmp    *0x8010b8(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800478:	c7 44 24 08 49 10 80 	movl   $0x801049,0x8(%esp)
  80047f:	00 
  ...
  8004aa:	b8 39 10 80 00       	mov    $0x801039,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c72:	00 
  800c73:	c7 44 24 08 2c 12 80 	movl   $0x80122c,0x8(%esp)
  800c7a:	00 
  800c7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c82:	00 
  800c83:	c7 04 24 49 12 80 00 	movl   $0x801249,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cdd:	e8 ba ff ff ff       	call   800c9c <sys_getenvid>
  800ce2:	8b 55 0c             	mov    0xc(%ebp),%edx
  800ce5:	89 54 24 10          	mov    %edx,0x10(%esp)
  800ce9:	8b 55 08             	mov    0x8(%ebp),%edx
  800cec:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800cf0:	89 74 24 08          	mov    %esi,0x8(%esp)
  800cf4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800cf8:	c7 04 24 58 12 80 00 	movl   $0x801258,(%esp)
  800cff:	e8 53 f4 ff ff       	call   800157 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800d04:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800d08:	8b 45 10             	mov    0x10(%ebp),%eax
  800d0b:	89 04 24             	mov    %eax,(%esp)
  800d0e:	e8 e3 f3 ff ff       	call   8000f6 <vcprintf>
	cprintf("\n");
  800d13:	c7 04 24 1c 10 80 00 	movl   $0x80101c,(%esp)
  800d1a:	e8 38 f4 ff ff       	call   800157 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800d1f:	cc                   	int3   
  800d20:	eb fd                	jmp    800d1f <_panic+0x53>
	...
