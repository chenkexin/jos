...
sys_env_destroy(envid_t envid)
{
  ...
  800142:	00 
  800143:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  80014a:	00 
  80014b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800152:	00 
  800153:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800201:	00 
  800202:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  800209:	00 
  80020a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800211:	00 
  800212:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80025f:	00 
  800260:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  800267:	00 
  800268:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80026f:	00 
  800270:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002bd:	00 
  8002be:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  8002c5:	00 
  8002c6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002cd:	00 
  8002ce:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80031b:	00 
  80031c:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  800323:	00 
  800324:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80032b:	00 
  80032c:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800379:	00 
  80037a:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  800381:	00 
  800382:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800389:	00 
  80038a:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80040a:	00 
  80040b:	c7 44 24 08 af 12 80 	movl   $0x8012af,0x8(%esp)
  800412:	00 
  800413:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80041a:	00 
  80041b:	c7 04 24 cc 12 80 00 	movl   $0x8012cc,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800460:	c7 04 24 dc 12 80 00 	movl   $0x8012dc,(%esp)
  ...
  800476:	e8 53 00 00 00       	call   8004ce <vcprintf>
	cprintf("\n");
  80047b:	c7 04 24 00 13 80 00 	movl   $0x801300,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80062c:	0f be 80 02 13 80 00 	movsbl 0x801302(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800828:	c7 44 24 08 1a 13 80 	movl   $0x80131a,0x8(%esp)
  80082f:	00 
  ...
  800848:	c7 44 24 08 23 13 80 	movl   $0x801323,0x8(%esp)
  80084f:	00 
  ...
  80087a:	b8 13 13 80 00       	mov    $0x801313,%eax
