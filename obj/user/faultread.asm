	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023c:	0f be 80 18 10 80 00 	movsbl 0x801018(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800367:	ff 24 85 a8 10 80 00 	jmp    *0x8010a8(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800458:	c7 44 24 08 39 10 80 	movl   $0x801039,0x8(%esp)
  80045f:	00 
  ...
  80048a:	b8 29 10 80 00       	mov    $0x801029,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c52:	00 
  800c53:	c7 44 24 08 1c 12 80 	movl   $0x80121c,0x8(%esp)
  800c5a:	00 
  800c5b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c62:	00 
  800c63:	c7 04 24 39 12 80 00 	movl   $0x801239,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cd8:	c7 04 24 48 12 80 00 	movl   $0x801248,(%esp)
  ...
  800cee:	e8 ef f3 ff ff       	call   8000e2 <vcprintf>
	cprintf("\n");
  800cf3:	c7 04 24 0c 10 80 00 	movl   $0x80100c,(%esp)
