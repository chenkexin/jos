...
libmain(int argc, char **argv)
{
  ...
  800066:	e8 31 0c 00 00       	call   800c9c <sys_getenvid>
...
exit(void)
{
  ...
  8000b1:	e8 89 0b 00 00       	call   800c3f <sys_env_destroy>
}
  8000b6:	c9                   	leave  
  8000b7:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000e5:	e8 f6 0a 00 00       	call   800be0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800136:	e8 b7 01 00 00       	call   8002f2 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80014e:	e8 8d 0a 00 00       	call   800be0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800253:	e8 b8 0e 00 00       	call   801110 <__umoddi3>
  800258:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80025c:	0f be 80 c8 12 80 00 	movsbl 0x8012c8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800387:	ff 24 85 80 13 80 00 	jmp    *0x801380(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800478:	c7 44 24 08 e9 12 80 	movl   $0x8012e9,0x8(%esp)
  80047f:	00 
  ...
  8004aa:	b8 d9 12 80 00       	mov    $0x8012d9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c72:	00 
  800c73:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800c7a:	00 
  800c7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c82:	00 
  800c83:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
  800c8a:	e8 d5 02 00 00       	call   800f64 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d31:	00 
  800d32:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800d39:	00 
  800d3a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d41:	00 
  800d42:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
  800d49:	e8 16 02 00 00       	call   800f64 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d8f:	00 
  800d90:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800d97:	00 
  800d98:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d9f:	00 
  800da0:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
  800da7:	e8 b8 01 00 00       	call   800f64 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ded:	00 
  800dee:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800df5:	00 
  800df6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfd:	00 
  800dfe:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
  800e05:	e8 5a 01 00 00       	call   800f64 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e4b:	00 
  800e4c:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800e53:	00 
  800e54:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e5b:	00 
  800e5c:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
  800e63:	e8 fc 00 00 00       	call   800f64 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ea9:	00 
  800eaa:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800eb1:	00 
  800eb2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eb9:	00 
  800eba:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
  800ec1:	e8 9e 00 00 00       	call   800f64 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800f3a:	00 
  800f3b:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800f42:	00 
  800f43:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f4a:	00 
  800f4b:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
  800f52:	e8 0d 00 00 00       	call   800f64 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f69:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800f6c:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800f6f:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800f75:	e8 22 fd ff ff       	call   800c9c <sys_getenvid>
  ...
  800f88:	89 74 24 08          	mov    %esi,0x8(%esp)
  800f8c:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f90:	c7 04 24 30 15 80 00 	movl   $0x801530,(%esp)
  800f97:	e8 bf f1 ff ff       	call   80015b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f9c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800fa0:	8b 45 10             	mov    0x10(%ebp),%eax
  800fa3:	89 04 24             	mov    %eax,(%esp)
  800fa6:	e8 4f f1 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800fab:	c7 04 24 bc 12 80 00 	movl   $0x8012bc,(%esp)
  800fb2:	e8 a4 f1 ff ff       	call   80015b <cprintf>
