...
umain(int argc, char **argv)
{
  ...
  80003a:	83 ec 2c             	sub    $0x2c,%esp
	...
	if ((who = fork()) != 0) {
  80003d:	e8 c2 0f 00 00       	call   801004 <fork>
  ...
  80004b:	e8 ec 0c 00 00       	call   800d3c <sys_getenvid>
  800050:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800054:	89 44 24 04          	mov    %eax,0x4(%esp)
  800058:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  ...
  800082:	e8 e3 0f 00 00       	call   80106a <ipc_send>
	}
  ...
  8000e6:	e8 7f 0f 00 00       	call   80106a <ipc_send>
		if (i == 10)
...
libmain(int argc, char **argv)
{
  ...
  80010a:	e8 2d 0c 00 00       	call   800d3c <sys_getenvid>
...
exit(void)
{
  ...
  800155:	e8 85 0b 00 00       	call   800cdf <sys_env_destroy>
}
  80015a:	c9                   	leave  
  80015b:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  800189:	e8 f2 0a 00 00       	call   800c80 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001da:	e8 b3 01 00 00       	call   800392 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001f2:	e8 89 0a 00 00       	call   800c80 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800295:	e8 96 0e 00 00       	call   801130 <__udivdi3>
  ...
  8002f3:	e8 88 0f 00 00       	call   801280 <__umoddi3>
  8002f8:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002fc:	0f be 80 53 14 80 00 	movsbl 0x801453(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800427:	ff 24 85 20 15 80 00 	jmp    *0x801520(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800518:	c7 44 24 08 74 14 80 	movl   $0x801474,0x8(%esp)
  80051f:	00 
  ...
  80054a:	b8 64 14 80 00       	mov    $0x801464,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800d12:	00 
  800d13:	c7 44 24 08 a4 16 80 	movl   $0x8016a4,0x8(%esp)
  800d1a:	00 
  800d1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d22:	00 
  800d23:	c7 04 24 c1 16 80 00 	movl   $0x8016c1,(%esp)
  800d2a:	e8 a5 03 00 00       	call   8010d4 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800dd1:	00 
  800dd2:	c7 44 24 08 a4 16 80 	movl   $0x8016a4,0x8(%esp)
  800dd9:	00 
  800dda:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de1:	00 
  800de2:	c7 04 24 c1 16 80 00 	movl   $0x8016c1,(%esp)
  800de9:	e8 e6 02 00 00       	call   8010d4 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e2f:	00 
  800e30:	c7 44 24 08 a4 16 80 	movl   $0x8016a4,0x8(%esp)
  800e37:	00 
  800e38:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e3f:	00 
  800e40:	c7 04 24 c1 16 80 00 	movl   $0x8016c1,(%esp)
  800e47:	e8 88 02 00 00       	call   8010d4 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e8d:	00 
  800e8e:	c7 44 24 08 a4 16 80 	movl   $0x8016a4,0x8(%esp)
  800e95:	00 
  800e96:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e9d:	00 
  800e9e:	c7 04 24 c1 16 80 00 	movl   $0x8016c1,(%esp)
  800ea5:	e8 2a 02 00 00       	call   8010d4 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800eeb:	00 
  800eec:	c7 44 24 08 a4 16 80 	movl   $0x8016a4,0x8(%esp)
  800ef3:	00 
  800ef4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800efb:	00 
  800efc:	c7 04 24 c1 16 80 00 	movl   $0x8016c1,(%esp)
  800f03:	e8 cc 01 00 00       	call   8010d4 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f49:	00 
  800f4a:	c7 44 24 08 a4 16 80 	movl   $0x8016a4,0x8(%esp)
  800f51:	00 
  800f52:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f59:	00 
  800f5a:	c7 04 24 c1 16 80 00 	movl   $0x8016c1,(%esp)
  800f61:	e8 6e 01 00 00       	call   8010d4 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800fda:	00 
  800fdb:	c7 44 24 08 a4 16 80 	movl   $0x8016a4,0x8(%esp)
  800fe2:	00 
  800fe3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fea:	00 
  800feb:	c7 04 24 c1 16 80 00 	movl   $0x8016c1,(%esp)
  800ff2:	e8 dd 00 00 00       	call   8010d4 <_panic>
...
fork(void)
{
  ...
  80100a:	c7 44 24 08 db 16 80 	movl   $0x8016db,0x8(%esp)
  801011:	00 
  801012:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801019:	00 
  80101a:	c7 04 24 cf 16 80 00 	movl   $0x8016cf,(%esp)
  801021:	e8 ae 00 00 00       	call   8010d4 <_panic>
...
sfork(void)
{
  ...
  80102c:	c7 44 24 08 da 16 80 	movl   $0x8016da,0x8(%esp)
  801033:	00 
  801034:	c7 44 24 04 59 00 00 	movl   $0x59,0x4(%esp)
  80103b:	00 
  80103c:	c7 04 24 cf 16 80 00 	movl   $0x8016cf,(%esp)
  801043:	e8 8c 00 00 00       	call   8010d4 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80104e:	c7 44 24 08 f0 16 80 	movl   $0x8016f0,0x8(%esp)
  801055:	00 
  801056:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  80105d:	00 
  80105e:	c7 04 24 09 17 80 00 	movl   $0x801709,(%esp)
  801065:	e8 6a 00 00 00       	call   8010d4 <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801070:	c7 44 24 08 13 17 80 	movl   $0x801713,0x8(%esp)
  801077:	00 
  801078:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  80107f:	00 
  801080:	c7 04 24 09 17 80 00 	movl   $0x801709,(%esp)
  801087:	e8 48 00 00 00       	call   8010d4 <_panic>

0080108c <ipc_find_env>:
...
ipc_find_env(enum EnvType type)
{
  ...
  801092:	a1 50 00 c0 ee       	mov    0xeec00050,%eax
  801097:	39 c8                	cmp    %ecx,%eax
  801099:	74 17                	je     8010b2 <ipc_find_env+0x26>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  80109b:	b8 01 00 00 00       	mov    $0x1,%eax
		if (envs[i].env_type == type)
  8010a0:	6b d0 7c             	imul   $0x7c,%eax,%edx
  8010a3:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8010a9:	8b 52 50             	mov    0x50(%edx),%edx
  8010ac:	39 ca                	cmp    %ecx,%edx
  8010ae:	75 14                	jne    8010c4 <ipc_find_env+0x38>
  8010b0:	eb 05                	jmp    8010b7 <ipc_find_env+0x2b>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8010ba:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8010bf:	8b 40 40             	mov    0x40(%eax),%eax
  8010c2:	eb 0e                	jmp    8010d2 <ipc_find_env+0x46>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8010c7:	3d 00 04 00 00       	cmp    $0x400,%eax
  8010cc:	75 d2                	jne    8010a0 <ipc_find_env+0x14>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  8010ce:	66 b8 00 00          	mov    $0x0,%ax
}
  8010d2:	5d                   	pop    %ebp
  8010d3:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010d9:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  8010dc:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8010df:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8010e5:	e8 52 fc ff ff       	call   800d3c <sys_getenvid>
  8010ea:	8b 55 0c             	mov    0xc(%ebp),%edx
  8010ed:	89 54 24 10          	mov    %edx,0x10(%esp)
  8010f1:	8b 55 08             	mov    0x8(%ebp),%edx
  8010f4:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8010f8:	89 74 24 08          	mov    %esi,0x8(%esp)
  8010fc:	89 44 24 04          	mov    %eax,0x4(%esp)
  801100:	c7 04 24 2c 17 80 00 	movl   $0x80172c,(%esp)
  801107:	e8 f3 f0 ff ff       	call   8001ff <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80110c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801110:	8b 45 10             	mov    0x10(%ebp),%eax
  801113:	89 04 24             	mov    %eax,(%esp)
  801116:	e8 83 f0 ff ff       	call   80019e <vcprintf>
	cprintf("\n");
  80111b:	c7 04 24 47 14 80 00 	movl   $0x801447,(%esp)
  801122:	e8 d8 f0 ff ff       	call   8001ff <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  801127:	cc                   	int3   
  801128:	eb fd                	jmp    801127 <_panic+0x53>
