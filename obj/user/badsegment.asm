...
sys_env_destroy(envid_t envid)
{
  ...
  80011e:	00 
  80011f:	c7 44 24 08 da 0f 80 	movl   $0x800fda,0x8(%esp)
  800126:	00 
  800127:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012e:	00 
  80012f:	c7 04 24 f7 0f 80 00 	movl   $0x800ff7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001a4:	c7 04 24 08 10 80 00 	movl   $0x801008,(%esp)
  ...
  8001ba:	e8 53 00 00 00       	call   800212 <vcprintf>
	cprintf("\n");
  8001bf:	c7 04 24 2c 10 80 00 	movl   $0x80102c,(%esp)
