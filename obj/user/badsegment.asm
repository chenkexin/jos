...
sys_env_destroy(envid_t envid)
{
  ...
  800136:	00 
  800137:	c7 44 24 08 8a 12 80 	movl   $0x80128a,0x8(%esp)
  80013e:	00 
  80013f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800146:	00 
  800147:	c7 04 24 a7 12 80 00 	movl   $0x8012a7,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001f5:	00 
  8001f6:	c7 44 24 08 8a 12 80 	movl   $0x80128a,0x8(%esp)
  8001fd:	00 
  8001fe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800205:	00 
  800206:	c7 04 24 a7 12 80 00 	movl   $0x8012a7,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80023c:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  800253:	00 
  800254:	c7 44 24 08 8a 12 80 	movl   $0x80128a,0x8(%esp)
  80025b:	00 
  80025c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800263:	00 
  800264:	c7 04 24 a7 12 80 00 	movl   $0x8012a7,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002b1:	00 
  8002b2:	c7 44 24 08 8a 12 80 	movl   $0x80128a,0x8(%esp)
  8002b9:	00 
  8002ba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c1:	00 
  8002c2:	c7 04 24 a7 12 80 00 	movl   $0x8012a7,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80030f:	00 
  800310:	c7 44 24 08 8a 12 80 	movl   $0x80128a,0x8(%esp)
  800317:	00 
  800318:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80031f:	00 
  800320:	c7 04 24 a7 12 80 00 	movl   $0x8012a7,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80036d:	00 
  80036e:	c7 44 24 08 8a 12 80 	movl   $0x80128a,0x8(%esp)
  800375:	00 
  800376:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80037d:	00 
  80037e:	c7 04 24 a7 12 80 00 	movl   $0x8012a7,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8003fe:	00 
  8003ff:	c7 44 24 08 8a 12 80 	movl   $0x80128a,0x8(%esp)
  800406:	00 
  800407:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80040e:	00 
  80040f:	c7 04 24 a7 12 80 00 	movl   $0x8012a7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80042d:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800430:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800433:	8b 35 00 20 80 00    	mov    0x802000,%esi
  ...
  80044c:	89 74 24 08          	mov    %esi,0x8(%esp)
  800450:	89 44 24 04          	mov    %eax,0x4(%esp)
  800454:	c7 04 24 b8 12 80 00 	movl   $0x8012b8,(%esp)
  ...
  80046a:	e8 53 00 00 00       	call   8004c2 <vcprintf>
	cprintf("\n");
  80046f:	c7 04 24 dc 12 80 00 	movl   $0x8012dc,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004fe:	e8 af 01 00 00       	call   8006b2 <vprintfmt>
	sys_cputs(b.buf, b.idx);
